...
export const BurgerIngredients: FC = () => {
  const buns: TIngredient[] = useSelector((state: RootState) =>
    state.ingredients.ingredients.filter((item) => item.type === 'bun')
  );
  const mains: TIngredient[] = useSelector((state: RootState) =>
    state.ingredients.ingredients.filter((item) => item.type === 'main')
  );
  const sauces: TIngredient[] = useSelector((state: RootState) =>
